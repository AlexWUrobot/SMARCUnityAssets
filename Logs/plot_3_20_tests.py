...
plt.figure()
plt.subplot(2, 1, 1)
plt.plot(repeat_simulation_ith, dist_between_rope_and_UAV, label='dist_between_rope_and_UAV velocity 0.5 m/s')
plt.plot(repeat_simulation_ith_2, dist_between_rope_and_UAV_2, label='dist_between_rope_and_UAV_velocity 1 m/s')
plt.plot(repeat_simulation_ith_4, dist_between_rope_and_UAV_4, label='dist_between_rope_and_UAV_velocity 1.5 m/s')
...
plt.subplot(2, 1, 2)
plt.plot(repeat_simulation_ith, wind_field, label='wind_field_effect_on_rope 0.5 m/s')
plt.plot(repeat_simulation_ith_2, wind_field_2, label='wind_field_effect_on_rope 1 m/s')
plt.plot(repeat_simulation_ith_4, wind_field_4, label='wind_field_effect_on_rope 1.5 m/s')
