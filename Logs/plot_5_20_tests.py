...
df6 = pd.read_csv(os.path.join(os.path.dirname(__file__), 'log_repeat_v6.csv'))  # velocity 3 m/s
...
plt.plot(repeat_simulation_ith_6, dist_between_rope_and_UAV_6, label=' 3 m/s')
...
plt.plot(repeat_simulation_ith_6, wind_field_6, label=' 3 m/s')
